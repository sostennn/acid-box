...
| `generator/acid-generator.ts` (lot 6)    | Déterminisme à seed égale ; pas 0 = tonique ; toutes les notes dans la gamme ; densités observées dans une tolérance sur 200 tirages ; densité 0 → aucun drapeau ; densité 1 → tous ; undo restaure `previousBass`                                                                                                                                                                                                                                                                                                                                                                              |
| `persistence/serialize.ts` (lot 7)       | Aller-retour JSON ; structure invalide → défauts ; valeur hors bornes bornée ; champ `version`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
